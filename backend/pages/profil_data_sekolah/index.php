      ...
      <div class="card">
        <div class="card-body mt-3">
          ...
          <table class="table mt-3">
            ...
            <tbody>
              <?php include "../../actions/profil_data_sekolah/showAll.php";
              $no = 1;
              while ($item = $result->fetch_object()): ?>
                <tr>
                  <td><?= $no++ ?></td>
                  <td><img src="../../../storages/images/profil_data_sekolah/<?= $item->foto ?>" alt="foto"
                  ...
                  <td style="width: 5%;"><a
                      href="../../actions/profil_data_sekolah/destroy.php?id=<?= $item->id ?>"
