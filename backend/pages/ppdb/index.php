          ...
          <table class="table">
            <tbody>
              ...
              <tr>
                ...
                <td><?= $ppdb_title->judul ?></td>
              </tr>
              <tr>
                <th>Sub Judul</th>
                <th>:</th>
                <td><?= $ppdb_title->sub_judul ?></td>
              </tr>
              <tr>
                <th>Foto</th>
                <th>:</th>
                <td><img src="../../../storages/images/ppdb_title/<?= $ppdb_title->foto ?>" alt="foto"
      ...
      <div class="card">
        <div class="card-body mt-3">
          ...
          <table class="table">
            ...
            <tbody>
              <?php include "../../actions/ppdb/showAll.php";
              $no = 1;
              while ($item = $result->fetch_object()): ?>
                <tr>
                  <td><?= $no++ ?></td>
                  <td><?= $item->icon ?></td>
                  <td><?= $item->title_judul ?></td>
                  ...
                  <td style="width: 5%;"><a
                      href="../../actions/ppdb/destroy.php?id=<?= $item->id ?>"
