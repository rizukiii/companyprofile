...
<?php $title = 'Create Data Konsentrasi Keahlian';
$section = 'create_data_konsentrasi_keahlian' ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body mt-3">
                    <form action="../../actions/konsentrasi_keahlian/store.php" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
