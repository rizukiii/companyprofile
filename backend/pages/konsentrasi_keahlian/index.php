          ...
          <table class="table">
            <tbody>
              ...
              <tr>
                ...
                <td><?= $konsentrasi_keahlian_title->judul ?></td>
              </tr>
              <tr>
                <th>Sub Judul</th>
                <th>:</th>
                <td><?= $konsentrasi_keahlian_title->sub_judul ?></td>
              </tr>
            </tbody>
          ...
          <table class="table">
            ...
            <tbody>
              ...
              while ($item = $result->fetch_object()): ?>
                <tr>
                  <td><?= $no++ ?></td>
                  <td><img src="../../../storages/images/konsentrasi_keahlian/<?= $item->foto ?>" alt="foto"
                  ...
                  <td style="width: 5%;"><a
                      href="../../actions/konsentrasi_keahlian/destroy.php?id=<?= $item->id ?>"
